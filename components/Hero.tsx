    ...
    <section className="relative min-h-screen flex flex-col justify-center pt-32 pb-12">
      <div className="w-full max-w-[1440px] mx-auto space-y-8">
        ...
        <div
          ...
          className="w-full mt-12 group overflow-hidden aspect-[4/3] md:aspect-[2/1]"
        >
          <Parallax speed={-30}>
            <img
              src="/Hero.jpg"
        ...
        <h1 className="text-5xl absolute bottom-24 left-2 md:text-8xl lg:text-[116px] font-semibold tracking-tight text-light-text dark:text-dark-text">
          Design & Engineer
          <br />
          Products
        </h1>
